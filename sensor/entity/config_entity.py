...
class DataValidationConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.data_validation_report_path: str = os.path.join(
             self.data_validation_dir,
             training_pipeline.DATA_VALIDATION_REPORT_FILE_DIR,
...
class DataTransformationConfig:
     def __init__(self, training_pipeline_config:TrainingPipelineConfig):
          ...
          self.transformed_object_file_path: str = os.path.join(self.data_transformation_dir, training_pipeline.DARA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR, training_pipeline.PREPROCESSING_OBJECT_FILE_NAME,)

class ModelTrainerConfig:
     
     def __init__(self,training_pipeline_config:TrainingPipelineConfig):
          self.mode_trainer_dir: str = os.path.join(training_pipeline_config.artifact_dir, training_pipeline.MODEL_TRAINER_DIR_NAME)
          
          self.trained_model_file_path: str = os.path.join(
               self.mode_trainer_dir,training_pipeline.MODEL_TRAINER_TRAINED_MODEL_DIR,
...
class ModelEvaluaitonConfig:
     
     def __init__(self,training_peline_config:TrainingPipelineConfig):
          self.model_evaluation_dir: str = os.path.join(
               training_peline_config.artifact_dir,training_pipeline.MODEL_EVALUATION_DIR_NAME
          )
